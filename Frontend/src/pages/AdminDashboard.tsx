...
const confirmReject = async () => {
  ...
  try {
    ...
    const response = await axios.put(
      `http://localhost:5000/api/pharmacies/${selectedPharmacyForAction.pharmacy_id}/reject`,
      {},
      {
        headers: {
          'Authorization': `Bearer ${token}`,
    ...
    toast.success(`${selectedPharmacyForAction.pharmacy_name} rejected successfully!`);
    // Refresh the pharmacies list
    await fetchPharmacies();
  } catch (error: any) {
